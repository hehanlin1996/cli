...
var ImMessagesSend = common.Shortcut{
	...
	Flags: []common.Flag{
		...
		{Name: "content", Desc: "(one of --content/--text/--markdown/--image/--file/--video/--audio required) message content JSON; use @file or - to read JSON from a file or stdin", Input: []string{common.File, common.Stdin}},
